...
public class PDFDB {
    ...
    public void insertNewMap(String SHA1, 
    		String path, int defaultPage) throws SQLException {
    	...
    	Log.i(TAG, "insert " + path + " into " + MAP_TABLE);
    }
    ...
    class PdfDBHelper extends SQLiteOpenHelper {
